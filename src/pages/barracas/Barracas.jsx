...
import hotDog from '../../imgs/minihd.jpg';
import pizza from '../../imgs/pizza.jpg';
import pastel from '../../imgs/pastel.jpg';
import nuggets from '../../imgs/nuggets.jpg';
import batata from '../../imgs/bt.jpg';
...
const barracas = [
  { id: 1, title: "Mini Hot - Dog", description: "Barraquinha de Mini Hot-Dog.", image: hotDog },
  ...
  { id: 5, title: "Batata Frita", description: "Barraquinha de Batata Frita.", image: batata },
